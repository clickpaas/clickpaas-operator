...
func CreateMongoCRD(extensionClient apiextensions.Interface) error {
	crdName := strings.ToLower(fmt.Sprintf("%s.%s", crdv1alpha1.MongoClusterPlural, crdv1alpha1.SchemeGroupVersion.Group))
	clusterCrd := &apiextensionsv1.CustomResourceDefinition{
		...
		Spec: apiextensionsv1.CustomResourceDefinitionSpec{
			...
			Names: apiextensionsv1.CustomResourceDefinitionNames{
				Plural:     crdv1alpha1.MongoClusterPlural,
				Singular:   crdv1alpha1.MongoClusterSingular,
				Kind:       crdv1alpha1.MongoClusterKind,
				ShortNames: []string{crdv1alpha1.MongoClusterShort},
			},
