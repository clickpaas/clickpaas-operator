...
func CreateRedisIdGeneratorCRD(extensionClient apiextensions.Interface) error {
	crdName := strings.ToLower(fmt.Sprintf("%s.%s", crdv1alpha1.IdGeneratePlural, crdv1alpha1.SchemeGroupVersion.Group))
	clusterCrd := &apiextensionsv1.CustomResourceDefinition{
		...
		Spec: apiextensionsv1.CustomResourceDefinitionSpec{
			...
			Names: apiextensionsv1.CustomResourceDefinitionNames{
				Plural:     crdv1alpha1.IdGeneratePlural,
				Singular:   crdv1alpha1.IdGenerateSingular,
				Kind:       crdv1alpha1.IdGenerateKind,
				ShortNames: []string{crdv1alpha1.IdGenerateShort},
			},
