...
func NewDeploymentManager(kubeClient kubernetes.Interface, deploymentLister appv1lister.DeploymentLister)operator.DeploymentManager{
...
func (d *deploymentManager) Create(obj interface{}, f func(interface{})(*appv1.Deployment,error)) (*appv1.Deployment, error) {
	deployment,err := f(obj)
	if err != nil{
		return nil,err
	}
...
func (d *deploymentManager) Update(obj interface{}, f func(interface{})(*appv1.Deployment,error)) (*appv1.Deployment, error) {
	deployment,err := f(obj)
	if err != nil{
		return nil,err
	}
...
func (d *deploymentManager) Delete(obj interface{}, f func(interface{})(*appv1.Deployment,error)) error {
	deployment,err := f(obj)
	if err != nil{
		return err
	}
...
func (d *deploymentManager) Get(obj interface{}, f func(interface{})(*appv1.Deployment,error)) (*appv1.Deployment, error) {
	deployment,err := f(obj)
	if err != nil{
		return nil,err
	}
