...
import (
	...
	middleware "l0calh0st.cn/clickpaas-operator/pkg/client/informers/externalversions/middleware"
)
...
func (f *sharedInformerFactory) Middleware() middleware.Interface {
	return middleware.New(f, f.namespace, f.tweakListOptions)
}
